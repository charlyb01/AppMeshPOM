...
{
  double a = Area();
  double aa = Triangle(p, Triangle::p[1], Triangle::p[2]).Area();
  double ab = Triangle(p, Triangle::p[0], Triangle::p[2]).Area();
  double ac = Triangle(p, Triangle::p[0], Triangle::p[1]).Area();
